...
import { GetByIdDTOResquest } from "../../../../../application/useCases/investment/getById/GetByIdDTO";
    ...
    protected async executeImpl(req: DecodedExpressRequest, res: Response): Promise<any> {
        try {
            ...
            if (result.isLeft()) {
                ...
                const dto: Investment = result.value.getValue();
                return this.ok<Investment>(res, dto);
            }
