...
export class DomainEvents {
  ...
  public static asDomainEventHandler<T extends IDomainEvent>(
    handler: (event: T) => void | Promise<void>
  ): (event: IDomainEvent) => void | Promise<void> {
    return (event: IDomainEvent) => handler(event as T);
  }


  public static register(callback: (event: IDomainEvent) => Promise<void> | void, eventClassName: string): void {
