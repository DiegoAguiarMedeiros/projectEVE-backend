...
export class Investment {
  ...
  public static create(props: InvestmentProps): Result<Investment> {
    ...
    if (guardResult.isFailure) {
      return Result.fail<Investment>('Investment :' + guardResult.getErrorValue());
    }
    ...
    return Result.ok<Investment>(investment);
  }
}
